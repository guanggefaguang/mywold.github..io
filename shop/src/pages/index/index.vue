  ...
  <div>
    <div class="swiper-container">
      <div class="swiper-wrapper">
        ...
        <!--</a>-->
        <!--</div>-->
        <div class="swiper-slide"><img src="../../m-images/week-banner.jpg"/></div>
        <div class="swiper-slide"><img src="../../m-images/week-banner.jpg"/></div>
        <div class="swiper-slide"><img src="../../m-images/week-banner.jpg"/></div>
        <div class="swiper-slide"><img src="../../m-images/week-banner.jpg"/></div>
        <div class="swiper-slide"><img src="../../m-images/week-banner.jpg"/></div>
    ...
    <div class="nav clearfix">
      ...
      <a href="javascript:;" class="nav-item"><img src="../../m-images/index-support.png">保障</a>
      <a href="javascript:;" class="nav-item" @click="gointe"><img src="../../m-images/index-gift.png">积分商城</a>
    </div>
    ...
    <div class="hot clearfix" v-if="indexData!={}" v-cloak>
      ...
      <ul class="clearfix">
        ...
        <!--&lt;!&ndash;<img v-bind:data-src="data.url"/>&ndash;&gt;-->
        <!--</router-link>-->
        <!--</li>-->
        <li><img src="../../m-images/week-banner.jpg" style="width: 100%;height: 100%;"/></li>
        <li><img src="../../m-images/logistics-bg.jpg" style="width: 100%;height: 100%;"/></li>
        <li><img src="../../m-images/logistics-bg.jpg" style="width: 100%;height: 100%;"/></li>
        <li><img src="../../m-images/week-banner.jpg" style="width: 100%;height: 100%;"/></li>
      </ul>
    </div>
