<template>
<div class="com-header" v-show="comHeaderFlag">
  <router-link to="search" class="search-logo"></router-link>
  <router-link to="shopCar" class="shopping-logo"><span></span></router-link>
...
.com-header .search-logo,
.com-header .shopping-logo,
.com-header .home-logo {
    position: absolute;
    right: 4.586rem;
    top: .9rem;
    width: 1.667rem;
    height: 1.667rem;
    background:url(../m-images/shopSao.png) no-repeat;
...
.com-header .com-header-back,
.com-header .com-header-back-white {
    position: absolute;
    top: 1rem;
    left: 0.875rem;
    width: 1.4rem;
