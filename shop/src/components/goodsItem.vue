<template>
  ...
  <li>
    <router-link to="/goodsDetails">
      <div class="no-goods" v-show="false">已抢光</div>
      <div class="goods-img">
        <img src="../m-images/aa.jpg" width="100%" />
      </div>
      <p class="goods-der"><span class="activity" v-show="false"></span>ENFGH 日化防晒霜妮蔻黑色的减肥<span></span></p>
      <div class="goods-price">
        <ins class="current-price">¥<span>185.00</span></ins>
        <del class="original-price">¥<span>200.00</span></del>
      </div>
    </router-link>
  </li>
